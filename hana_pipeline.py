...
def parse_args():
    import argparse
    parser = argparse.ArgumentParser(prog='hana_scaffold')
...
def main():
    ...
    # # Go to the directory and find the configure file "hana_config.json".
    ...
    hana_scaffold.add_search_path(r'E:\Documents\PHD\AGIS\builds')
    print(hana_scaffold.extract(fasta_path=r'W:\bare_allhic\contigs_sim.fasta',
                                mapping=[r'W:\bare_allhic\sample.bwa_mem.bam'],
                                output_prefix=r'W:\bare\bare', enzyme='MboI'))
    return 0
