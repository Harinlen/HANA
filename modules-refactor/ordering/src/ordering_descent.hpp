...
HMR_CONTIG_ID_VEC ordering_descent_optimize(int32_t phase, int npop, int ngen, int maxgen, double mutapb, ORDERING_INFO& info, std::mt19937_64& rng, int threads);
