...
HMR_ARG_PARSER args_parser = {
    ...
    { {"-e", "--enzymes"}, "ENZYMES", "Enzymes to be found in the sequence", LAMBDA_PARSE_ARG {opts.enzyme = arg; }},
    ...
    { {"--weight-enzymes"}, "WEIGHT_ENZYMES", "Enzymes to used for weight calculation", LAMBDA_PARSE_ARG {opts.weight_enzyme = arg; }},
